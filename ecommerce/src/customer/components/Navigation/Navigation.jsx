          ...
          <div className="flex h-16 items-center px-4">
            ...
            <div className="flex-1 lg:flex lg:items-center lg:justify-between">
              ...
              <div className="hidden lg:flex lg:gap-x-12">
                {navigation.categories.map((category) => (
                  <Popover key={category.name} className="relative">
                    <PopoverButton className="inline-flex items-center text-base font-medium text-gray-900">
                      {category.name}
                      <svg
                    ...
                    <PopoverPanel className="absolute inset-x-0 top-full text-sm text-gray-500">
                      ...
                      <div className="relative grid max-w-screen-xl grid-cols-2 gap-x-8 py-10 px-6">
              ...
              <div className="flex lg:hidden">
                <button
                  type="button"
                  className="inline-flex items-center p-2 text-gray-400"
                >
